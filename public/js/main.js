...
var homeHeroSlider = function homeHeroSlider() {
  if (!_utilities_selectors__WEBPACK_IMPORTED_MODULE_0__["default"].homeHeroSlider) return;
  var slider = _utilities_selectors__WEBPACK_IMPORTED_MODULE_0__["default"].homeHeroSlider;
  jQuery(slider).slick({
    arrows: true,
    dots: false,
    infinite: true,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (homeHeroSlider);
